public class Main {
    ...
    public static void task7(){
        ...
        var weightFirstFighter = 78.2;
        var weightSecondFight = 82.7;
        var differenceWeightFighters = weightSecondFight - weightFirstFighter;
    ...
    public static void task8(){
        ...
        var companyEmployees = allTime / oneEmployeeTime;
        System.out.println("Всего работников в компании - " + companyEmployees + " человек.");
        companyEmployees = companyEmployees + 94;
        allTime = oneEmployeeTime * companyEmployees;
